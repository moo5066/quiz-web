  ...
  return (
    <div className='text-black flex justify-around mt-50'>
       ...
       <div className='border border-gray-300 w-[400px] h-60 sm:h-50 p-3  rounded-lg mx-5 '>
          ...
          <div className='py-4'>
              <h1 className='text-xl font-bold'>Physics 101</h1>
              <p className='text-gray-500'>Science</p>
          </div>
          <Link href="/sceince/physics-quiz" className='py-2 block w-[90%]  mx-auto bg-black text-white p-1 text-center rounded-lg font-semibold' >Start Quiz</Link>
        </div>

        <div className='border border-gray-300 w-[400px] h-60 sm:h-50 p-3 rounded-md rounded-lg mx-5 '>
          <div className='flex justify-between space-x-10'>
              <GiOpenBook  size={40} className='bg-blue-200 p-2 text-blue-500 rounded-lg'/>
              <p className='border  flex justify-center items-center p-0.5 border-gray-300 rounded-lg text-sm'>40s/question</p>
          </div>

          <div className='py-4'>
              <h1 className='text-xl font-bold'>Biology Basics</h1>
              <p className='text-gray-500'>Science</p>
          </div>
          <Link href="/sceince/bio-quiz" className='py-2 block w-[90%]  mx-auto bg-black text-white p-1 text-center rounded-lg font-semibold' >Start Quiz</Link>
        </div>
    </div>
  )
}
