  ...
  return (
    <div className='text-black mt-100 mx-auto max-h-2'>
       ...
       <div className='border border-gray-300 w-[400px] h-60 sm:h-50 p-3  rounded-lg mx-5 '>
          ...
          <div className='py-4'>
              <h1 className='text-xl font-bold'>World History</h1>
              <p className='text-gray-500'>History</p>
          </div>
          <Link href="/history/history-quiz" className='py-2 block w-[90%]  mx-auto bg-black text-white p-1 text-center rounded-lg font-semibold' >Start Quiz</Link>
        </div>
    </div>
  )
}
