...
const quizData = [
  {
    ...
    options: ["A JavaScript library for building user interfaces", "A database management system", "A server-side framework"],
    answer: "A JavaScript library for building user interfaces"
  },
  {
    question: "What is JSX?",
    options: ["A syntax extension for JavaScript", "A new programming language", "A database query language"],
  ...
  },
  {
    ...
    options: ["A direct copy of the real DOM", "A lightweight copy of the real DOM", "A virtual reality interface"],
    ...
    <div className='text-black  h-screen flex flex-col  '>
      <div className='p-10 w-[70%] mx-auto mt-20 bg-indigo-50 rounded-lg shadow-md'>
        <div className='flex justify-between items-center pt-10'>
          <div>
            <h1 className='font-bold text-xl'>React Basics</h1>
