...
const Page = () => {
  return (
    <div className="text-black mt-100">
      <Link
        href="/dashboard"
        className="absolute left-0 top-0 p-5 text-black"
      >
        <IoMdArrowRoundBack size={20} />
      </Link>

      <div className="border border-gray-300 w-[400px] h-60 p-3 rounded-lg mx-5">
        <div className="flex justify-between">
          <GiOpenBook
            size={40}
            className="bg-blue-200 p-2 text-blue-500 rounded-lg"
          />
          <p className="border flex justify-center items-center px-2 border-gray-300 rounded-lg text-sm">
            30s/question
          </p>
        </div>
        ...
        <Link
          href="/general-knowladge/Geography"
          className="block w-[90%] mx-auto bg-black text-white p-2 text-center rounded-lg font-semibold"
        >
          Start Quiz
        </Link>
      </div>
